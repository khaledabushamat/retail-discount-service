...
| 10 | Should the 2-year tenure and $5-per-$100 amounts be configurable like the rates? | No — they stay as constants          | Rates are values a business changes without a release. These are structural: they define what each rule is, not how much it gives. A discount_rates table with a minimum_years column that is null for three of four rows would be a worse design than the small duplication.  |
